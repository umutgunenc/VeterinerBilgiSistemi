...
{
    public class AdresEditleValidators : AbstractValidator<AdresEditleViewModel>
    {
        public AdresEditleValidators()
        {
            RuleFor(x => x.IletisimBilgileriId)
                .NotEmpty().WithMessage("Lütfen formun bilgilierini değiştirmeyiniz.")
                .NotNull().WithMessage("Lütfen formun bilgilierini değiştirmeyiniz.")
                .Must(FunctionsValidator.BeIletisimBilgileri).WithMessage("Lütfen formun bilgilierini değiştirmeyiniz.");
            ...
            RuleFor(x => x.SubeAdi)
                ...
                .Must((model, SubeAdi) => FunctionsValidator.BeUniqueSubeAdi(model.IletisimBilgileriId, SubeAdi)).WithMessage("Girilen şube adı zaten sistemde kayıtlı.");
            ...
            RuleFor(x => x.AktifMi)
                .NotNull().WithMessage("Lütfen formun bilgilierini değiştirmeyiniz.b")
                .Must(x => x == true || x == false).WithMessage("Lütfen formun bilgilierini değiştirmeyiniz.c");
        }
    }
}
